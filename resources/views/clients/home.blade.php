        ...
        <div class="row justify-content-center">
            @foreach ($tours as $tour)
                <div class="col-xxl-3 col-xl-4 col-md-6 mb-4">
                    <div class="destination-item bg-white rounded-4 shadow-sm h-100 overflow-hidden" data-aos="fade-up" data-aos-duration="1500"
                        ...
                        <div class="image position-relative" style="height: 220px; overflow: hidden;">
                            ...
                            <div class="ratting position-absolute bottom-0 start-0 m-3 z-3 bg-white text-dark px-2 py-1 rounded shadow-sm fw-bold"><i class="fas fa-star text-warning"></i> {{ number_format($tour->rating, 1) }}</div>
                        ...
                        <div class="content p-4">
                            ...
                            <h5 class="mb-3" style="min-height: 48px; line-height: 1.4;"><a href="{{ route('tour-detail', ['id' => $tour->tourId]) }}" class="text-dark text-decoration-none">{{ $tour->title }}</a>
                            </h5>
                            <span class="time d-block text-muted mb-3" style="font-size: 14px;"><i class="fal fa-clock me-2"></i>{{ $tour->time }}</span>
                        </div>
                        <div class="destination-footer d-flex justify-content-between align-items-center p-4 border-top bg-light">
                            <span class="price fw-bold" style="color: var(--secondary-color); font-size: 18px;">{{ number_format($tour->priceAdult, 0, ',', '.') }} <small class="text-muted fw-normal fs-6">VND</small></span>
...
<section class="popular-destinations-area rel z-1 pt-80 pb-50">
                ...
                <div class="row justify-content-center g-4">
                    @foreach ($toursPopular as $tour)
                        ...
                        <div class="col-lg-4 col-md-6 mb-4 item">
                            <div class="destination-item position-relative rounded-4 overflow-hidden shadow-sm h-100" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50" style="transition: all 0.3s;">
                                ...
                                <div class="content position-absolute bottom-0 start-0 w-100 p-4 z-3 text-white" style="background: linear-gradient(to top, rgba(0,0,0,0.6) 0%, transparent 100%);">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="{{ route('tour-detail', ['id' => $tour->tourId]) }}" class="btn btn-sm btn-light rounded-circle text-primary shadow" style="width: 35px; height: 35px; line-height: 25px;"><i
    ...
    <div class="container">
        <div class="row align-items-center">
                ...
                <div class="features-content-part mb-55" data-aos="fade-right" data-aos-duration="1500"
                    ...
                    <div class="features-customer-box bg-white p-4 rounded-4 shadow-sm d-flex align-items-center">
                        ...
                        <div class="content">
                            ...
                            <p class="text-muted mb-0">Với hơn 15 năm kinh nghiệm đồng hành cùng du khách trên mọi nẻo đường.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-6" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="feature-item bg-white p-4 rounded-4 shadow-sm h-100 text-center" style="transition: all 0.3s;">
                            <div class="icon mb-3 text-primary fs-1"><i class="flaticon-tent"></i></div>
                            <div class="content">
                                <h5 class="fw-bold mb-2"><a href="{{ route('tours') }}" class="text-dark text-decoration-none">Chất lượng dịch vụ</a></h5>
                                <p class="text-muted mb-0" style="font-size: 14px;">Đảm bảo trải nghiệm tốt nhất với tiêu chuẩn dịch vụ cao cấp.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="feature-item bg-white p-4 rounded-4 shadow-sm h-100 text-center" style="transition: all 0.3s;">
                            <div class="icon mb-3 text-primary fs-1"><i class="flaticon-guide"></i></div>
                            <div class="content">
                                <h5 class="fw-bold mb-2"><a href="{{ route('tours') }}" class="text-dark text-decoration-none">Hướng dẫn viên</a></h5>
                                <p class="text-muted mb-0" style="font-size: 14px;">Đội ngũ giàu kinh nghiệm, nhiệt tình và am hiểu điểm đến.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="feature-item bg-white p-4 rounded-4 shadow-sm h-100 text-center mt-md-4" style="transition: all 0.3s;">
                            <div class="icon mb-3 text-primary fs-1"><i class="flaticon-support"></i></div>
                            <div class="content">
                                <h5 class="fw-bold mb-2"><a href="{{ route('tours') }}" class="text-dark text-decoration-none">Hỗ trợ 24/7</a></h5>
                                <p class="text-muted mb-0" style="font-size: 14px;">Luôn sẵn sàng giải đáp và hỗ trợ mọi vấn đề của khách hàng.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="feature-item bg-white p-4 rounded-4 shadow-sm h-100 text-center mt-md-4" style="transition: all 0.3s;">
                            <div class="icon mb-3 text-primary fs-1"><i class="flaticon-discount"></i></div>
                            <div class="content">
                                <h5 class="fw-bold mb-2"><a href="{{ route('tours') }}" class="text-dark text-decoration-none">Giá cả hợp lý</a></h5>
                                <p class="text-muted mb-0" style="font-size: 14px;">Mức giá cạnh tranh cùng nhiều chương trình ưu đãi hấp dẫn.</p>
                            </div>
                        </div>
                    </div>
                </div>
