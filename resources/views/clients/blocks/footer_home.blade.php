                ...
                <div class="col col-md-6 col-10 col-small" data-aos="fade-up" data-aos-delay="200"
                    ...
                    <div class="footer-widget footer-contact">
                        ...
                        <ul class="list-style-one">
                            <li><i class="fal fa-map-marked-alt"></i> 38 Nguyen Nhan,Cam Le, Da Nang</li>
                            <li><i class="fal fa-envelope"></i> <a
                                    href="mailto:minhdien.dev@gmail.com">thanhtamvo849@gmail.com</a></li>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="copyright-text text-center text-lg-start">
                        <p>@Copy 2024 <a href="{{ route('home') }}">LOTUSMILE</a>, All rights reserved</p>
                    </div>
                </div>
...
<script> window.chtlConfig = { chatbotId: "8852774698" } </script>
