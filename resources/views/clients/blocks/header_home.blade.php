...
<body>
    <div class="page-wrapper">
        ...
        <header class="main-header header-vietravel">
            ...
            <!--Header-Upper-->
            <div class="header-upper shadow-sm bg-white sticky-top">
                <div class="container-fluid clearfix">
                    <div class="header-inner rel d-flex align-items-center justify-content-between">

                        <div class="d-flex align-items-center">
                            <!-- Mobile Toggle -->
                            <button type="button" class="navbar-toggle d-lg-none me-3" data-bs-toggle="collapse" data-bs-target=".navbar-collapse" style="background: transparent; border: none; font-size: 24px;">
                            ...
                            <div class="menu-btns d-flex align-items-center">
                                <div class="user-dropdown-wrap dropdown">
                                    <a href="#" class="d-flex align-items-center text-dark text-decoration-none" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        @endphp
                                        <img class="rounded-circle shadow-sm" src="{{ asset('admin/assets/images/user-profile/' . $avatar) }}" style="width: 35px; height: 35px; object-fit: cover; border: 2px solid white;">
                                        @else
                                        <div class="rounded-circle bg-light d-flex align-items-center justify-content-center shadow-sm" style="width: 35px; height: 35px; border: 2px solid white;">
                                            <i class="fas fa-user" style="color: var(--primary-color); font-size: 16px;"></i>
                                        </div>
                                        @endif
                                        <div class="ms-2 d-none d-sm-block text-start">
                                            <span class="d-block text-muted" style="font-size: 12px; line-height: 1;">Tài khoản</span>
                                            <span class="d-block fw-600" style="font-size: 14px; line-height: 1.2; color: var(--heading-color);">{{ session()->get('username', 'Đăng nhập') }} <i class="fas fa-angle-down ms-1" style="font-size: 12px;"></i></span>
                                        </div>
                                    </a>
