...
<tr>
    ...
    <td class="align-middle text-center">
        @if ($booking->paymentMethod == 'zalopay-payment')
        <div class="d-flex align-items-center justify-content-center">
            <img src="{{ asset('clients/assets/images/booking/zalopay-logo.jpg') }}" class="icon_payment" alt="ZaloPay" style="height: 24px; width: auto; object-fit: contain; margin-right: 6px; border-radius: 3px;">
            <span class="font-weight-bold" style="font-size: 13px;">ZaloPay</span>
        </div>
        @elseif ($booking->paymentMethod == 'vnpay-payment')
        <div class="d-flex align-items-center justify-content-center">
            <img src="{{ asset('clients/assets/images/booking/vnpay-logo.jpg') }}" class="icon_payment" alt="VNPay" style="height: 24px; width: auto; object-fit: contain; margin-right: 6px; border-radius: 3px;">
            <span class="font-weight-bold" style="font-size: 13px;">VNPay</span>
        </div>
        @else
        <div class="d-flex align-items-center justify-content-center">
            <i class="fa fa-money text-success" style="font-size: 22px; margin-right: 6px;" title="Tiền mặt"></i>
            <span class="font-weight-bold" style="font-size: 13px;">Tiền mặt</span>
        </div>
        @endif
    </td>
